...
[在 LabEx 开始学习路径](https://labex.io/zh/learn/cks)
...
|   序号 | 名称                        | 难度   | 练习                                                                                                                |
|------|---------------------------|------|-------------------------------------------------------------------------------------------------------------------|
|    1 | 使用 NetworkPolicy 限制命名空间流量 | 中级   | [开始挑战](https://labex.io/zh/labs/restrict-namespace-traffic-with-networkpolicy-663191?course=cks-practice-exam-01) |
|    2 | 使用 TLS Ingress 发布管理控制台    | 中级   | [开始挑战](https://labex.io/zh/labs/publish-an-admin-console-with-tls-ingress-663189?course=cks-practice-exam-01)     |
|    3 | 部署前验证 Kubernetes 二进制文件    | 中级   | [开始挑战](https://labex.io/zh/labs/verify-kubernetes-binaries-before-deployment-663194?course=cks-practice-exam-01)  |

#### Cluster Hardening

|   序号 | 名称                          | 难度   | 练习                                                                                                              |
|------|-----------------------------|------|-----------------------------------------------------------------------------------------------------------------|
|    1 | 缩减权限过大的 ClusterRoleBinding  | 中级   | [开始挑战](https://labex.io/zh/labs/reduce-an-overprivileged-clusterrolebinding-663190?course=cks-practice-exam-01) |
|    2 | 禁用默认 ServiceAccount 令牌挂载    | 中级   | [开始挑战](https://labex.io/zh/labs/disable-default-serviceaccount-token-mounts-663178?course=cks-practice-exam-01) |
|    3 | 限制 Incident Reader API 访问权限 | 中级   | [开始挑战](https://labex.io/zh/labs/limit-incident-reader-api-access-663186?course=cks-practice-exam-01)            |

#### System Hardening

|   序号 | 名称                       | 难度   | 练习                                                                                                            |
|------|--------------------------|------|---------------------------------------------------------------------------------------------------------------|
|    1 | 在工作负载上强制执行 AppArmor 配置文件 | 高级   | [开始挑战](https://labex.io/zh/labs/enforce-an-apparmor-profile-on-a-workload-663179?course=cks-practice-exam-01) |
|    2 | 安装本地 Seccomp 配置文件        | 高级   | [开始挑战](https://labex.io/zh/labs/install-a-local-seccomp-profile-663183?course=cks-practice-exam-01)           |

#### Minimize Microservice Vulnerabilities

|   序号 | 名称               | 难度   | 练习                                                                                                       |
|------|------------------|------|----------------------------------------------------------------------------------------------------------|
|    1 | 强制执行受限 Pod 安全策略  | 中级   | [开始挑战](https://labex.io/zh/labs/enforce-restricted-pod-security-663181?course=cks-practice-exam-01)      |
|    2 | 使用投影卷保护 Secret   | 中级   | [开始挑战](https://labex.io/zh/labs/protect-secrets-with-projected-files-663188?course=cks-practice-exam-01) |
|    3 | 加固运行时安全上下文       | 中级   | [开始挑战](https://labex.io/zh/labs/harden-a-runtime-security-context-663182?course=cks-practice-exam-01)    |
|    4 | 隔离高风险 Sidecar 边界 | 高级   | [开始挑战](https://labex.io/zh/labs/isolate-a-risky-sidecar-boundary-663185?course=cks-practice-exam-01)     |

#### Supply Chain Security

|   序号 | 名称                     | 难度   | 练习                                                                                                          |
|------|------------------------|------|-------------------------------------------------------------------------------------------------------------|
|    1 | 构建最小化合规镜像              | 中级   | [开始挑战](https://labex.io/zh/labs/build-a-minimal-approved-image-663176?course=cks-practice-exam-01)          |
|    2 | 验证 SBOM 和校验和证据         | 中级   | [开始挑战](https://labex.io/zh/labs/verify-sbom-and-checksum-evidence-663195?course=cks-practice-exam-01)       |
|    3 | 使用 KubeLinter 扫描工作负载清单 | 中级   | [开始挑战](https://labex.io/zh/labs/scan-workload-manifests-with-kubelinter-663193?course=cks-practice-exam-01) |
|    4 | 将工作负载固定为已批准的镜像摘要       | 高级   | [开始挑战](https://labex.io/zh/labs/pin-workloads-to-approved-image-digests-663187?course=cks-practice-exam-01) |

#### Monitoring, Logging and Runtime Security

|   序号 | 名称                | 难度   | 练习                                                                                                        |
|------|-------------------|------|-----------------------------------------------------------------------------------------------------------|
|    1 | 审查 Secret 访问的审计事件 | 中级   | [开始挑战](https://labex.io/zh/labs/review-audit-events-for-secret-access-663192?course=cks-practice-exam-01) |
|    2 | 检测可疑的运行时进程        | 高级   | [开始挑战](https://labex.io/zh/labs/detect-a-suspicious-runtime-process-663177?course=cks-practice-exam-01)   |
|    3 | 强制执行不可变运行时容器      | 中级   | [开始挑战](https://labex.io/zh/labs/enforce-immutable-runtime-containers-663180?course=cks-practice-exam-01)  |
|    4 | 调查未经授权的 API 活动    | 高级   | [开始挑战](https://labex.io/zh/labs/investigate-unauthorized-api-activity-663184?course=cks-practice-exam-01) |
...
|   序号 | 名称                      | 难度   | 练习                                                                                                           |
|------|-------------------------|------|--------------------------------------------------------------------------------------------------------------|
|    1 | 拒绝工作负载访问节点元数据           | 中级   | [开始挑战](https://labex.io/zh/labs/deny-workload-access-to-node-metadata-663200?course=cks-practice-exam-02)    |
|    2 | 审查 Kubelet 暴露的 CIS 调查结果 | 中级   | [开始挑战](https://labex.io/zh/labs/review-cis-findings-for-kubelet-exposure-663211?course=cks-practice-exam-02) |
|    3 | 为拆分式 Ingress 路由重新签发 TLS | 中级   | [开始挑战](https://labex.io/zh/labs/reissue-tls-for-a-split-ingress-route-663206?course=cks-practice-exam-02)    |

#### Cluster Hardening

|   序号 | 名称                      | 难度   | 练习                                                                                                        |
|------|-------------------------|------|-----------------------------------------------------------------------------------------------------------|
|    1 | 限定命名空间操作员的角色权限          | 中级   | [开始挑战](https://labex.io/zh/labs/scope-a-namespace-operator-role-663214?course=cks-practice-exam-02)       |
|    2 | 包含泄露的 ServiceAccount 令牌 | 高级   | [开始挑战](https://labex.io/zh/labs/contain-a-leaked-serviceaccount-token-663199?course=cks-practice-exam-02) |
|    3 | 拦截 API Server 代理提权      | 高级   | [开始挑战](https://labex.io/zh/labs/block-api-server-proxy-escalation-663197?course=cks-practice-exam-02)     |

#### System Hardening

|   序号 | 名称          | 难度   | 练习                                                                                                          |
|------|-------------|------|-------------------------------------------------------------------------------------------------------------|
|    1 | 禁用主机调试服务    | 中级   | [开始挑战](https://labex.io/zh/labs/disable-a-host-debug-service-663202?course=cks-practice-exam-02)            |
|    2 | 限制主机日志收集器权限 | 中级   | [开始挑战](https://labex.io/zh/labs/restrict-host-log-collector-permissions-663210?course=cks-practice-exam-02) |

#### Minimize Microservice Vulnerabilities

|   序号 | 名称                        | 难度   | 练习                                                                                                            |
|------|---------------------------|------|---------------------------------------------------------------------------------------------------------------|
|    1 | 应用租户 Pod 安全边界             | 中级   | [开始挑战](https://labex.io/zh/labs/apply-tenant-pod-security-boundaries-663196?course=cks-practice-exam-02)      |
|    2 | 轮换并限制应用密钥                 | 中级   | [开始挑战](https://labex.io/zh/labs/rotate-and-constrain-application-secrets-663212?course=cks-practice-exam-02)  |
|    3 | 使用 DNS 例外隔离租户出口流量         | 高级   | [开始挑战](https://labex.io/zh/labs/isolate-tenant-egress-with-dns-exceptions-663204?course=cks-practice-exam-02) |
|    4 | 从 Web Pod 中移除 HostPath 缓存 | 中级   | [开始挑战](https://labex.io/zh/labs/remove-hostpath-cache-from-a-web-pod-663208?course=cks-practice-exam-02)      |

#### Supply Chain Security

|   序号 | 名称                       | 难度   | 练习                                                                                                     |
|------|--------------------------|------|--------------------------------------------------------------------------------------------------------|
|    1 | 强制执行受信任的镜像仓库             | 高级   | [开始挑战](https://labex.io/zh/labs/enforce-trusted-image-registries-663203?course=cks-practice-exam-02)   |
|    2 | 验证已签名的发布清单               | 中级   | [开始挑战](https://labex.io/zh/labs/validate-a-signed-release-manifest-663215?course=cks-practice-exam-02) |
|    3 | 从镜像中移除构建机密               | 高级   | [开始挑战](https://labex.io/zh/labs/remove-build-secrets-from-an-image-663207?course=cks-practice-exam-02) |
|    4 | 使用 KubeLinter 扫描 Helm 输出 | 中级   | [开始挑战](https://labex.io/zh/labs/scan-helm-output-with-kubelinter-663213?course=cks-practice-exam-02)   |

#### Monitoring, Logging and Runtime Security

|   序号 | 名称         | 难度   | 练习                                                                                                     |
|------|------------|------|--------------------------------------------------------------------------------------------------------|
|    1 | 从审计证据中恢复策略 | 中级   | [开始挑战](https://labex.io/zh/labs/restore-policy-from-audit-evidence-663209?course=cks-practice-exam-02) |
|    2 | 隔离信标工作负载   | 高级   | [开始挑战](https://labex.io/zh/labs/quarantine-a-beaconing-workload-663205?course=cks-practice-exam-02)    |
|    3 | 检测运行时文件漂移  | 中级   | [开始挑战](https://labex.io/zh/labs/detect-runtime-file-drift-663201?course=cks-practice-exam-02)          |
|    4 | 控制受损的作业令牌  | 高级   | [开始挑战](https://labex.io/zh/labs/contain-a-compromised-job-token-663198?course=cks-practice-exam-02)    |

### 3. [CKS 备考指南](https://labex.io/zh/courses/cks-prep)
