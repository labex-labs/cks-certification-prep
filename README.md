...
[Start Path on LabEx](https://labex.io/learn/cks)

**Courses**: 3 · **Labs**: 85

## Courses

### 1. [CKS Practice Exam 01](https://labex.io/courses/cks-practice-exam-01)
...
|---------|-----------------------------------------------|--------------|---------------------------------------------------------------------------------------------------------------------------|
|       1 | Restrict Namespace Traffic with NetworkPolicy | Intermediate | [Start Challenge](https://labex.io/labs/restrict-namespace-traffic-with-networkpolicy-663191?course=cks-practice-exam-01) |
|       2 | Publish an Admin Console with TLS Ingress     | Intermediate | [Start Challenge](https://labex.io/labs/publish-an-admin-console-with-tls-ingress-663189?course=cks-practice-exam-01)     |
|       3 | Verify Kubernetes Binaries Before Deployment  | Intermediate | [Start Challenge](https://labex.io/labs/verify-kubernetes-binaries-before-deployment-663194?course=cks-practice-exam-01)  |

#### Cluster Hardening

|   Index | Name                                        | Difficulty   | Practice                                                                                                                |
|---------|---------------------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------|
|       1 | Reduce an Overprivileged ClusterRoleBinding | Intermediate | [Start Challenge](https://labex.io/labs/reduce-an-overprivileged-clusterrolebinding-663190?course=cks-practice-exam-01) |
|       2 | Disable Default ServiceAccount Token Mounts | Intermediate | [Start Challenge](https://labex.io/labs/disable-default-serviceaccount-token-mounts-663178?course=cks-practice-exam-01) |
|       3 | Limit Incident Reader API Access            | Intermediate | [Start Challenge](https://labex.io/labs/limit-incident-reader-api-access-663186?course=cks-practice-exam-01)            |

#### System Hardening

|   Index | Name                                      | Difficulty   | Practice                                                                                                              |
|---------|-------------------------------------------|--------------|-----------------------------------------------------------------------------------------------------------------------|
|       1 | Enforce an AppArmor Profile on a Workload | Advanced     | [Start Challenge](https://labex.io/labs/enforce-an-apparmor-profile-on-a-workload-663179?course=cks-practice-exam-01) |
|       2 | Install a Local Seccomp Profile           | Advanced     | [Start Challenge](https://labex.io/labs/install-a-local-seccomp-profile-663183?course=cks-practice-exam-01)           |

#### Minimize Microservice Vulnerabilities

|   Index | Name                                 | Difficulty   | Practice                                                                                                         |
|---------|--------------------------------------|--------------|------------------------------------------------------------------------------------------------------------------|
|       1 | Enforce Restricted Pod Security      | Intermediate | [Start Challenge](https://labex.io/labs/enforce-restricted-pod-security-663181?course=cks-practice-exam-01)      |
|       2 | Protect Secrets with Projected Files | Intermediate | [Start Challenge](https://labex.io/labs/protect-secrets-with-projected-files-663188?course=cks-practice-exam-01) |
|       3 | Harden a Runtime Security Context    | Intermediate | [Start Challenge](https://labex.io/labs/harden-a-runtime-security-context-663182?course=cks-practice-exam-01)    |
|       4 | Isolate a Risky Sidecar Boundary     | Advanced     | [Start Challenge](https://labex.io/labs/isolate-a-risky-sidecar-boundary-663185?course=cks-practice-exam-01)     |

#### Supply Chain Security

|   Index | Name                                    | Difficulty   | Practice                                                                                                            |
|---------|-----------------------------------------|--------------|---------------------------------------------------------------------------------------------------------------------|
|       1 | Build a Minimal Approved Image          | Intermediate | [Start Challenge](https://labex.io/labs/build-a-minimal-approved-image-663176?course=cks-practice-exam-01)          |
|       2 | Verify SBOM and Checksum Evidence       | Intermediate | [Start Challenge](https://labex.io/labs/verify-sbom-and-checksum-evidence-663195?course=cks-practice-exam-01)       |
|       3 | Scan Workload Manifests with KubeLinter | Intermediate | [Start Challenge](https://labex.io/labs/scan-workload-manifests-with-kubelinter-663193?course=cks-practice-exam-01) |
|       4 | Pin Workloads to Approved Image Digests | Advanced     | [Start Challenge](https://labex.io/labs/pin-workloads-to-approved-image-digests-663187?course=cks-practice-exam-01) |

#### Monitoring, Logging and Runtime Security

|   Index | Name                                  | Difficulty   | Practice                                                                                                          |
|---------|---------------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------|
|       1 | Review Audit Events for Secret Access | Intermediate | [Start Challenge](https://labex.io/labs/review-audit-events-for-secret-access-663192?course=cks-practice-exam-01) |
|       2 | Detect a Suspicious Runtime Process   | Advanced     | [Start Challenge](https://labex.io/labs/detect-a-suspicious-runtime-process-663177?course=cks-practice-exam-01)   |
|       3 | Enforce Immutable Runtime Containers  | Intermediate | [Start Challenge](https://labex.io/labs/enforce-immutable-runtime-containers-663180?course=cks-practice-exam-01)  |
|       4 | Investigate Unauthorized API Activity | Advanced     | [Start Challenge](https://labex.io/labs/investigate-unauthorized-api-activity-663184?course=cks-practice-exam-01) |

### 2. [CKS Practice Exam 02](https://labex.io/courses/cks-practice-exam-02)
...
|   Index | Name                                     | Difficulty   | Practice                                                                                                             |
|---------|------------------------------------------|--------------|----------------------------------------------------------------------------------------------------------------------|
|       1 | Deny Workload Access to Node Metadata    | Intermediate | [Start Challenge](https://labex.io/labs/deny-workload-access-to-node-metadata-663200?course=cks-practice-exam-02)    |
|       2 | Review CIS Findings for Kubelet Exposure | Intermediate | [Start Challenge](https://labex.io/labs/review-cis-findings-for-kubelet-exposure-663211?course=cks-practice-exam-02) |
|       3 | Reissue TLS for a Split Ingress Route    | Intermediate | [Start Challenge](https://labex.io/labs/reissue-tls-for-a-split-ingress-route-663206?course=cks-practice-exam-02)    |

#### Cluster Hardening

|   Index | Name                                  | Difficulty   | Practice                                                                                                          |
|---------|---------------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------|
|       1 | Scope a Namespace Operator Role       | Intermediate | [Start Challenge](https://labex.io/labs/scope-a-namespace-operator-role-663214?course=cks-practice-exam-02)       |
|       2 | Contain a Leaked ServiceAccount Token | Advanced     | [Start Challenge](https://labex.io/labs/contain-a-leaked-serviceaccount-token-663199?course=cks-practice-exam-02) |
|       3 | Block API Server Proxy Escalation     | Advanced     | [Start Challenge](https://labex.io/labs/block-api-server-proxy-escalation-663197?course=cks-practice-exam-02)     |

#### System Hardening

|   Index | Name                                    | Difficulty   | Practice                                                                                                            |
|---------|-----------------------------------------|--------------|---------------------------------------------------------------------------------------------------------------------|
|       1 | Disable a Host Debug Service            | Intermediate | [Start Challenge](https://labex.io/labs/disable-a-host-debug-service-663202?course=cks-practice-exam-02)            |
|       2 | Restrict Host Log Collector Permissions | Intermediate | [Start Challenge](https://labex.io/labs/restrict-host-log-collector-permissions-663210?course=cks-practice-exam-02) |

#### Minimize Microservice Vulnerabilities

|   Index | Name                                      | Difficulty   | Practice                                                                                                              |
|---------|-------------------------------------------|--------------|-----------------------------------------------------------------------------------------------------------------------|
|       1 | Apply Tenant Pod Security Boundaries      | Intermediate | [Start Challenge](https://labex.io/labs/apply-tenant-pod-security-boundaries-663196?course=cks-practice-exam-02)      |
|       2 | Rotate and Constrain Application Secrets  | Intermediate | [Start Challenge](https://labex.io/labs/rotate-and-constrain-application-secrets-663212?course=cks-practice-exam-02)  |
|       3 | Isolate Tenant Egress with DNS Exceptions | Advanced     | [Start Challenge](https://labex.io/labs/isolate-tenant-egress-with-dns-exceptions-663204?course=cks-practice-exam-02) |
|       4 | Remove HostPath Cache from a Web Pod      | Intermediate | [Start Challenge](https://labex.io/labs/remove-hostpath-cache-from-a-web-pod-663208?course=cks-practice-exam-02)      |

#### Supply Chain Security

|   Index | Name                               | Difficulty   | Practice                                                                                                       |
|---------|------------------------------------|--------------|----------------------------------------------------------------------------------------------------------------|
|       1 | Enforce Trusted Image Registries   | Advanced     | [Start Challenge](https://labex.io/labs/enforce-trusted-image-registries-663203?course=cks-practice-exam-02)   |
|       2 | Validate a Signed Release Manifest | Intermediate | [Start Challenge](https://labex.io/labs/validate-a-signed-release-manifest-663215?course=cks-practice-exam-02) |
|       3 | Remove Build Secrets from an Image | Advanced     | [Start Challenge](https://labex.io/labs/remove-build-secrets-from-an-image-663207?course=cks-practice-exam-02) |
|       4 | Scan Helm Output with KubeLinter   | Intermediate | [Start Challenge](https://labex.io/labs/scan-helm-output-with-kubelinter-663213?course=cks-practice-exam-02)   |

#### Monitoring, Logging and Runtime Security

|   Index | Name                               | Difficulty   | Practice                                                                                                       |
|---------|------------------------------------|--------------|----------------------------------------------------------------------------------------------------------------|
|       1 | Restore Policy from Audit Evidence | Intermediate | [Start Challenge](https://labex.io/labs/restore-policy-from-audit-evidence-663209?course=cks-practice-exam-02) |
|       2 | Quarantine a Beaconing Workload    | Advanced     | [Start Challenge](https://labex.io/labs/quarantine-a-beaconing-workload-663205?course=cks-practice-exam-02)    |
|       3 | Detect Runtime File Drift          | Intermediate | [Start Challenge](https://labex.io/labs/detect-runtime-file-drift-663201?course=cks-practice-exam-02)          |
|       4 | Contain a Compromised Job Token    | Advanced     | [Start Challenge](https://labex.io/labs/contain-a-compromised-job-token-663198?course=cks-practice-exam-02)    |

### 3. [CKS Prep](https://labex.io/courses/cks-prep)
